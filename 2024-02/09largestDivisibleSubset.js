const verify = arr => {
  var ordered = [...arr].sort((a, b) => a - b);
  for (var i = 1; i < arr.length; i++) {
    if (ordered[i] % ordered[i - 1] > 0) { return false }
  }
  return true
}
